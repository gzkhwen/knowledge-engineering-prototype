...
const initialTools: ToolOption[] = [
  {
    ...
    connector: "RAG 算法服务",
    versions: [
      { id: "document-parser-v1-3-0", version: "v1.3.0", status: "已发布", connector: "RAG 算法服务", method: "POST", requestPath: "/rag_algorithm/parser" },
      { id: "document-parser-v1-4-0-alpha", version: "v1.4.0-alpha", status: "待调试", connector: "RAG 算法服务", method: "POST", requestPath: "/rag_algorithm/parser" },
      { id: "document-parser-v1-2-0", version: "v1.2.0", status: "已发布", connector: "RAG 算法服务", method: "POST", requestPath: "/rag_algorithm/parser" },
    ],
  },
  {
    id: "chunk-splitter",
    ...
    connector: "RAG 算法服务",
    versions: [
      { id: "chunk-splitter-v1-3-0", version: "v1.3.0", status: "已发布", connector: "RAG 算法服务", method: "POST", requestPath: "/rag_algorithm/splitter" },
      { id: "chunk-splitter-v1-2-1", version: "v1.2.1", status: "待发布", connector: "RAG 算法服务", method: "POST", requestPath: "/rag_algorithm/splitter" },
    ],
  },
  {
    id: "summary",
    ...
    connector: "模型生成服务",
    versions: [
      { id: "summary-v1-3-0", version: "v1.3.0", status: "已发布", connector: "模型生成服务", method: "POST", requestPath: "/rag_algorithm/summary" },
      { id: "summary-v1-4-0-alpha", version: "v1.4.0-alpha", status: "待调试", connector: "模型生成服务", method: "POST", requestPath: "/rag_algorithm/summary" },
    ],
  },
  {
    id: "qa-extractor",
    ...
    connector: "模型生成服务",
    versions: [
      { id: "qa-extractor-v1-3-0", version: "v1.3.0", status: "已发布", connector: "模型生成服务", method: "POST", requestPath: "/rag_algorithm/qa_extractor" },
    ],
  },
  {
    id: "ragas-evaluate",
    ...
    category: "质量评估",
    status: "停用",
    connector: "RAG 质量评估服务",
    versions: [
      { id: "ragas-evaluate-v1-1-0", version: "v1.1.0", status: "已停用", connector: "RAG 质量评估服务", method: "POST", requestPath: "/rag_algorithm/ragas_evaluate" },
    ],
  },
];
...
const initialServices: McpService[] = [
  {
    id: "svc-knowledge",
    name: "知识工程 Agent MCP",
    description: "生产环境默认服务，提供知识工程 Agent 构建知识库时需要调用的文档处理和智能生成工具。",
    instructions: "仅调用已发布工具版本；发起解析或生成前确认 project_id、source_id、素材范围和回调地址；失败时返回 trace_id 便于排查。",
    authTarget: "knowledge-agent-prod",
    status: "运行中",
    endpoint: "https://mcp.internal/toolhub/knowledge-agent",
    tools: [
      { toolId: "document-parser", versionId: "document-parser-v1-3-0" },
      { toolId: "chunk-splitter", versionId: "chunk-splitter-v1-3-0" },
      { toolId: "summary", versionId: "summary-v1-3-0" },
      { toolId: "qa-extractor", versionId: "qa-extractor-v1-3-0" },
    ],
    callsToday: 428,
    apiKeys: [
      { id: "key-live-agent", label: "知识工程 Agent 生产环境", key: "th_live_1_****************", status: "启用", createdAt: "2026-05-18 10:12", lastUsedAt: "2026-05-19 15:24" },
      { id: "key-live-debug", label: "联调测试", key: "th_live_2_****************", status: "启用", createdAt: "2026-05-17 16:40", lastUsedAt: "2026-05-19 11:08" },
    ],
  },
  {
    id: "svc-staging",
    name: "知识工程测试 MCP",
    description: "联调和版本验证使用的测试服务，绑定少量稳定版本。",
    instructions: "仅用于测试环境，不处理生产项目；允许调用历史版本验证兼容性。",
    authTarget: "knowledge-agent-staging",
    status: "停用",
    endpoint: "https://mcp.internal/toolhub/knowledge-staging",
    tools: [
      { toolId: "document-parser", versionId: "document-parser-v1-2-0" },
      { toolId: "chunk-splitter", versionId: "chunk-splitter-v1-3-0" },
    ],
    callsToday: 0,
    apiKeys: [
